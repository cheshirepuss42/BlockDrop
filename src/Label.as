package  
{
	...
	public class Label extends Entity
	{
		...
		public function setup(str:String,scrX:int,scrY:int, w:int, h:int, txtSize:int=15,txtColor:uint = 0xffffff, bgColor:uint = 0x888888, bgAlpha:Number = 0.8, borderSize:int = 2):Label
		{
			...
			//var img:Image = new Image(A.gfx["labelgradient"]);
			//img.alpha = bgAlpha;
